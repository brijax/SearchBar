...
{
  path: '/blog',
  component: ComponentCreator('/blog','15d'),
  exact: true,
},
{
  path: '/blog/hello-world',
  component: ComponentCreator('/blog/hello-world','225'),
  exact: true,
},
{
  path: '/blog/hola',
  component: ComponentCreator('/blog/hola','11b'),
  exact: true,
},
{
  path: '/blog/tags',
  component: ComponentCreator('/blog/tags','501'),
  exact: true,
},
{
  path: '/blog/tags/docusaurus',
  component: ComponentCreator('/blog/tags/docusaurus','b4b'),
  exact: true,
},
{
  path: '/blog/tags/facebook',
  component: ComponentCreator('/blog/tags/facebook','f1f'),
  exact: true,
},
{
  path: '/blog/tags/hello',
  component: ComponentCreator('/blog/tags/hello','f35'),
  exact: true,
},
{
  path: '/blog/tags/hola',
  component: ComponentCreator('/blog/tags/hola','619'),
  exact: true,
},
{
  path: '/blog/welcome',
  component: ComponentCreator('/blog/welcome','6b1'),
  exact: true,
},
{
  path: '/markdown-page',
...
{
  path: '/search',
  component: ComponentCreator('/search','e49'),
  exact: true,
},
{
  path: '/docs',
